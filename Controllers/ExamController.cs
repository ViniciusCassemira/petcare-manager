...
namespace system_petshop.Controllers
{
    ...
    public class ExamController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ExamId,Description,Value")] Exam exam)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExamId,Description,Value")] Exam exam)
        {
            if (id != exam.ExamId)
            {
                return NotFound();
